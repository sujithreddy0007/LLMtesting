...
class EvaluatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Evaluate = channel.unary_unary(
                ...
                response_deserializer=evaluator__pb2.EvaluateResponse.FromString,
...
def add_EvaluatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Evaluate': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=evaluator__pb2.EvaluateResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Evaluator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Evaluator', rpc_method_handlers)
...
class Evaluator(object):
    ...
    def Evaluate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Evaluator/Evaluate',
            evaluator__pb2.EvaluateRequest.SerializeToString,
            evaluator__pb2.EvaluateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
